...
-- Dark mode
hl.env("QT_QPA_PLATFORMTHEME", "gnome")  -- Qt follows GTK theme
...
local mod = "SUPER"
-- 1. Print Screen: Take a screenshot of the entire screen and save it
hl.bind(mainMod .. " + F4", hl.dsp.exec_cmd('grim -g "$(slurp)" ~/pictures/screenshots/$(date +"%Y-%m-%d-%H%M%S_screenshot.png")'))
